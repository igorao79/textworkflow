...
async function createAllTables() {
  ...
  try {
    ...
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_workflows_is_active ON workflows(is_active)`);
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_workflows_created_at ON workflows(created_at DESC)`);
    ...
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_workflow_executions_started_at ON workflow_executions(started_at DESC)`);
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_workflow_execution_logs_execution_id ON workflow_execution_logs(execution_id)`);
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_workflow_execution_logs_timestamp ON workflow_execution_logs(timestamp DESC)`);
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_pqueue_tasks_status ON pqueue_tasks(status)`);
    await pool.query(`CREATE INDEX IF NOT EXISTS idx_pqueue_tasks_created_at ON pqueue_tasks(created_at DESC)`);
